/* =====================================================================
 *  myLRA Web コントローラ (Web Bluetooth + OpenCV.js)
 *  ---------------------------------------------------------------------
 *  Version : 1.2.0   (2026-06-12)   ※ファーム main.cpp と対応
 *
 *  現在の状態 / 主な機能:
 *    - Mode 1 記録 / Mode 2 自動追尾 / Mode 3 動作確認 /
 *      Mode 4 動画解析 / Mode 5 別波形 / Mode 6 自動パラメータ計測
 *    - 2色トラッキング(黄=中心 / 赤=前方)で位置・向きを推定
 *    - 検出設定: クリックで色キャリブレーション・マスク表示・
 *      解像度/最小面積/ノイズ除去の調整
 *    - 接続後にデバイス名(XIAO_LRA_xxxx)を表示
 *
 *  更新履歴:
 *    1.2.0 - 検出精度改善(色取得/マスク表示/中心色除外)・BLE名表示
 *    1.1.0 - 画像処理の軽量化・低遅延化・Mode6追加
 *    1.0.0 - Web BLE制御の初版
 * ===================================================================== */
